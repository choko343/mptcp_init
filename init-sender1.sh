...
eth0=enp1s0      # NIC name
eth1=enp2s0

eth0_nw=192.168.1.0 # network
eth1_nw=192.168.11.0

eth0_ip=192.168.1.1 # IP address
eth1_ip=192.168.11.1

eth0_gw=192.168.1.2 # Gateway IP address
eth1_gw=192.168.11.2
